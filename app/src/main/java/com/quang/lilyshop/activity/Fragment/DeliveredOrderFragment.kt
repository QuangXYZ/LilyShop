...
import com.quang.lilyshop.databinding.FragmentDeliveredOrderBinding
 ...
 * Use the [DeliveredOrderFragment.newInstance] factory method to
...
class DeliveredOrderFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(orders: ArrayList<OrderModel>?): DeliveredOrderFragment {
            val fragment = DeliveredOrderFragment()
